...
export function AnimatedCursor() {
  ...
  useEffect(() => {
    ...
    return () => window.matchMedia("(pointer: coarse)").removeEventListener("change", checkMobile);
  }, []);
  ...
  return (
    <>
      ...
      />
      <motion.div
        className="fixed top-0 left-0 w-32 h-32 border border-primary/20 rounded-full pointer-events-none z-[99]"
        animate={{
